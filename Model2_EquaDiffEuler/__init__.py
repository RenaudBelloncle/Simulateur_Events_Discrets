...
from Model2_EquaDiffEuler.IntegratorTime import IntegratorTime
from Model2_EquaDiffEuler.IntegratorState import IntegratorState
...
simulator_EquaDiffEuler = Simulator(2, [s1, s2, s3, s4, adder, integrator_time, integrator_state])
